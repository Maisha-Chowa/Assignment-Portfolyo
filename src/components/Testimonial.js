...
const Testimonial = () => {
  ...
  useEffect(async () => {
    ...
    setDynamicData(responseData?.user?.testimonials);
    console.log(responseData?.user?.testimonials);
    //console.log(dynamicData);
  }, []);

  // {
  //   dynamicData?.map((data, i) => console.log(data?.review));
  // }
